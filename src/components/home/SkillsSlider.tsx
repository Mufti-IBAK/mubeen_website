...
export const SkillsSlider: React.FC<SkillsSliderProps> = ({ programs }) => {
  ...
  const tabs: { id: Tab; label: string }[] = [
    { id: 'flagship', label: 'Flagship Skills' },
  ...
  return (
    <section className="py-16 bg-[hsl(var(--card))] border-y border-[hsl(var(--border))]" ref={containerRef}>
      <div className="container-page">
        <div className="mb-10 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Skill Up Programs</h2>
        ...
        {filteredPrograms.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-[hsl(var(--muted-foreground))]">No skill programs found in this category right now.</p>
            <Link href="/skill-up" className="text-brand-primary hover:underline mt-2 inline-block">View all skills</Link>
          </div>
        ) : (
        ...
        <div className="text-center mt-8">
           <Link href="/skill-up" className="btn-outline">View All Skills</Link>
        </div>
      </div>
    </section>
  );
