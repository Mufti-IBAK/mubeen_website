...
export function AdminSidebarNew({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const nav = [
    ...
    { href: "/admin/quotes", label: "Wisdom Quotes", icon: FaFileAlt },
    { href: "/admin/forms", label: "Form Builder", icon: FaFileAlt },
    { href: "/admin/enrollments", label: "Enrollment Registry", icon: FaFileAlt },
    { href: "/admin/payment-tools", label: "Payment Tools", icon: FaCreditCard },
