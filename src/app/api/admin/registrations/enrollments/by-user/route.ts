...
export async function GET(req: NextRequest) {
  try {
    ...
    let query = admin
      .from('enrollments')
      .select('id, user_id, user_name, user_email, type, program_id, program_title, amount, currency, description, tx_ref, transaction_id, status, created_at, form_data, payment_status')
